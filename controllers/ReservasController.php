...
class ReservasController extends Controller
{
    ...
    {
        $this->comprobarVuelosDisponibles($vuelo_id);
    ...
    protected function comprobarVuelosDisponibles($vuelo_id)
    {
        ...
        //la \ es porque DateTime esta definido en el espacio global
